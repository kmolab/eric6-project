...
# Form implementation generated from reading ui file 'E:\project\github\eric6-17.08\eric\E5Gui\E5ZoomWidget.ui'
#
...
if __name__ == "__main__":
    ...
    E5ZoomWidget = QtWidgets.QWidget()
    ui = Ui_E5ZoomWidget()
    ui.setupUi(E5ZoomWidget)
    E5ZoomWidget.show()
    sys.exit(app.exec_())
