...
# Form implementation generated from reading ui file 'E:\project\github\eric6-17.08\eric\E5Gui\E5ListSelectionDialog.ui'
#
...
if __name__ == "__main__":
    ...
    E5ListSelectionDialog = QtWidgets.QDialog()
    ui = Ui_E5ListSelectionDialog()
    ui.setupUi(E5ListSelectionDialog)
    E5ListSelectionDialog.show()
    sys.exit(app.exec_())
